...
// Fonctions getZenModeState et saveZenModeState sont SUPPRIMÉES

// Distractions (Utilisation LS)
...
export async function getAllAppData() {
    ...
    try {
        ...
        // allData.settings.isZenModeEnabled = getZenModeState(); // <<< SUPPRIMÉ
